...
file_to_edit = open('C:\\Users\\Nirbhey Singh Pahwa\\Documents\\College(Engg.)\\Vora ma\'am\'s work\\example.csv', 'a')
...
def make_file():
    file_to_edit = open('C:\\Users\\Nirbhey Singh Pahwa\\Documents\\College(Engg.)\\Vora ma\'am\'s work\\example.csv','a')
    file_to_edit.write('S.No,OHU,Gender,Age,Religion,Caste,Scholarship,Time_to_reach_college(HRS),X_pct,X_Board,XII_pct,XII_Board,Diploma_pct,University,Private_Class,Number_of_Subjects,Overall_Attendance,Major_Illness,Score_of_Exam_CET,Score_of_Exam_AIEEE,Fathers_Ocuupation,Fathers_Education,F_Stream,F_Health_Issue,Mothers_Ocuupation,Mothers_Education,M_Stream,M_Health_Issue,Family_Income,No_of_Siblings,Extra_Curricular_Activity,Active_in_Sports,Drop,SEM1_CGPA,SEM1_KT,SEM2_CGPA,SEM2_KT,SEM3_CGPA,SEM3_KT,SEM4_CGPA,SEM4_KT,SEM5_CGPA,SEM5_KT,SEM6_CGPA,SEM6_KT\n')
    file_to_edit.close()
